...
<!-- CAPABILITIES:START -->
**239** 条固定 revision 候选：Copy 63 · Wrapper 120 · Bridge 29 · 未分类 27
...
完整记录、分项得分与逐行信号见 [data/capabilities.json](data/capabilities.json)。快照：2026-08-22T13:19:15.206Z。分数只衡量观测到的适配工作量，不代表兼容、安全、质量或许可证已获准。
<!-- CAPABILITIES:END -->
