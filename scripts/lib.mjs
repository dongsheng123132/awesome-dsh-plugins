...
const CATEGORY_RULES = [
  ...
  ['release-engineering', ['release proof', 'release verification', 'artifact provenance', 'mirror consistency']],
  ['benchmarking', ['benchmark manifest', 'benchmark evidence', 'deterministic benchmark', 'regression threshold']],
  ['provenance-lineage', ['data lineage', 'action lineage', 'derived-from', 'produced-by', 'lineage closure']],
  ['recovery-evidence', ['recovery proof', 'recovery drill', 'rollback evidence', 'stale-plan rejection', 'rto evidence']],
  ['action-parity', ['action parity', 'action id', 'cross-surface action', 'data-action-id', 'binding parity']],
